...
public class MensaDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + MensaContract.MensaEntry.TABLE_NAME + " (" +
                    ...
                    MensaContract.MensaEntry.COLUMN_NAME_LOCATION + TEXT_TYPE + COMMA_SEP +
                    "UNIQUE(" + MensaContract.MensaEntry.COLUMN_NAME_DATE + COMMA_SEP +
                    MensaContract.MensaEntry.COLUMN_NAME_TITLE + COMMA_SEP + MensaContract.MensaEntry.COLUMN_NAME_LOCATION +
                    ") ON CONFLICT REPLACE" +
                    " )";
