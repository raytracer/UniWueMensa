...
public class MensaMeal {
    ...
    public boolean writeToDatabase(SQLiteDatabase db, String name) {
        ...
        values.put(MensaContract.MensaEntry.COLUMN_NAME_LOCATION, name);
    ...
    public static ArrayList<MensaMeal> readFromDataBase(SQLiteDatabase db, Date day, String name) {
        ...
        Cursor cur = db.query(true, MensaContract.MensaEntry.TABLE_NAME,
                ...
                MensaContract.MensaEntry.COLUMN_NAME_DATE + "=? AND " + MensaContract.MensaEntry.COLUMN_NAME_LOCATION + "=?",
                new String[]{String.valueOf(day.getTime()), name}, null, null, null, null);
